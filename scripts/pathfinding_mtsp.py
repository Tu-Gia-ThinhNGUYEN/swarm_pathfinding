...
path_package = '/home/swarmpc/catkin_ws/src/swarm_pathfinding/json/mTSP'
...
def make_plan(req):
  ...
  json_generalPath["p"] = generalPath
  # Serializing json
  ...
  object_generalPath = json.dumps(json_generalPath, indent=1)
  ...
  with open(path_opttimalPath, "w") as outfile:
    outfile.write(object_generalPath)
